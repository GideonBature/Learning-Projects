...
Incase you are using a more recent version of the `scarb init` command, you will be prompted to choose between setting up your project as `Starknet Foundry (default)` or `Cairo Test`. Go ahead and press enter, which will go ahead and select the `Starknet Foundry (default)`. It's going to look like this:

![image](https://github.com/user-attachments/assets/2aeb4dde-338e-47f9-99fe-69e87273e83f)

You can then go ahead and open the folder in your `vs code` or whichsoever code editor you are making use of.
